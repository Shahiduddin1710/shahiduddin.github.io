...
"undefined" == typeof jQuery.migrateMute &&
  (jQuery.migrateMute = !0), (function(a, b) {
  "use strict";
  function c(c) {
    var d = b.console;
    e[c] ||
  ...
  var e = {};
  (a.migrateWarnings = []), void 0 === a.migrateTrace &&
  ...
  (a.fn.init = function(a) {
    ...
    return "string" == typeof a &&
      "#" === a &&
      (c("jQuery( '#' ) is not a valid selector"), (b[0] = [])), f.apply(
      this,
      b
    );
  ...
  (a.fn.size = function() {
    return c("jQuery.fn.size() is deprecated; use the .length property"), this
      .length;
    ...
    var e = g(b),
      f = d(b);
    return e !== f &&
      c("jQuery.isNumeric() should not be called on constructed objects"), f;
  }), d(
    a,
    "unique",
    a.uniqueSort,
  ...
  (a.event.props = []), (a.event.fixHooks = {}), (a.event.fix = function(b) {
    ...
    undelegate: function(a, b, d) {
      return c("jQuery.fn.undelegate() is deprecated"), 1 === arguments.length
        ? this.off(a, "**")
        : this.off(b, a || "**", d);
    },
  });
  ...
  a.fn.andSelf = function() {
    return c("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()"), w.apply(
      this,
      arguments
    );
  };
  ...
  a.Deferred = function(b) {
    ...
    return (d.pipe = e.pipe = function() {
      var b = arguments;
      return c("deferred.pipe() is deprecated"), a
        .Deferred(function(c) {
          a.each(y, function(f, g) {
            ...
            d[g[1]](function() {
              ...
              b && a.isFunction(b.promise)
                ? b.promise().done(c.resolve).fail(c.reject).progress(c.notify)
                : c[g[0] + "With"](
