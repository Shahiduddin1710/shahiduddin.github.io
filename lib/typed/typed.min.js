        ...
        a = (function() {
          ...
          return i(t, [
            ...
            },
            {
              ...
              value: function() {
                ...
                (this.typingComplete = !1), this.shuffleStringsIfNeeded(
                  this
                ), this.insertCursor(), this.bindInputFocusEvents &&
                  this.bindFocusEvents(), (this.timeout = setTimeout(
                  function() {
                ...
                return this.pause.status === !0
                  ...
                  : void (this.timeout = setTimeout(function() {
                      ...
                      if ("^" === r.charAt(0) && /^\^\d+/.test(r)) {
                        var a = 1;
                        (r = /\d+/.exec(r)[0]), (a += r.length), (n = parseInt(
                          r
                        )), (s.temporaryPause = !0), s.options.onTypingPaused(
                          s.arrayPos,
                          s
                        ), (t =
                          t.substring(0, e) +
                          t.substring(e + a)), s.toggleBlinking(!0);
                      }
                      if ("`" === r.charAt(0)) {
                        for (
                          ;
                      ...
                      s.timeout = setTimeout(function() {
                        s.toggleBlinking(
                          !1
                        ), e === t.length ? s.doneTyping(t, e) : s.keepTyping(t, e, i), s.temporaryPause && ((s.temporaryPause = !1), s.options.onTypingResumed(s.arrayPos, s));
                      }, n);
                    }, n));
              },
            },
            ...
            },
            {
              ...
              value: function(t, e) {
                ...
                this.options.onStringTyped(
                  this.arrayPos,
                  this
                ), this.toggleBlinking(!0), (this.arrayPos ===
            ...
            },
            {
              key: "complete",
              value: function() {
                this.options.onComplete(this), this.loop
                  ? this.curLoop++
              ...
              value: function() {
                ...
                return (this.el.className += " " + this.fadeOutClass), this
                  ...
                  (this.cursor.className +=
                    " " + this.fadeOutClass), setTimeout(function() {
          ...
          return o(t, [
            {
              ...
              value: function(t, e, s) {
                ...
                (t.strPos = 0), (t.arrayPos = 0), (t.stopNum = 0), (t.loop =
                  t.options.loop), (t.loopCount =
                  t.options.loopCount), (t.curLoop = 0), (t.shuffle =
                  t.options.shuffle), (t.sequence = []), (t.pause = {
                  status: !1,
                  typewrite: !0,
                  curString: "",
                  curStrPos: 0,
                ...
                (t.currentElContent = this.getCurrentElContent(
                  ...
                  t.options.autoInsertCss), this.appendAnimationCss(t);
              },
            },
            {
