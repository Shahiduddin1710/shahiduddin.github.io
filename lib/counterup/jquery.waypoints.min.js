...
!(function() {
  ...
  function t(o) {
    ...
    (this.key = "waypoint-" + e), (this.options = t.Adapter.extend(
      ...
      (this.options.offset =
        t.offsetAliases[this.options.offset]), this.group.add(
      this
  ...
  function e(t) {
    (this.element = t), (this.Adapter = n.Adapter), (this.adapter = new this
      .Adapter(t)), (this.key =
      "waypoint-context-" +
      ...
      for (var a in this.waypoints[r]) {
        ...
        d.element !== d.element.window &&
          ...
          : "string" == typeof f &&
            ...
            ), (l = s.contextScroll - s.contextOffset), (d.triggerPoint =
          y + l - f), (h = w < s.oldScroll), (p =
  ...
  function i(t) {
    (this.name = t.name), (this.axis = t.axis), (this.id =
      this.name +
      "-" +
      this.axis), (this.waypoints = []), this.clearTriggerQueues(), (o[
      this.axis
    ][this.name] = this);
  }
