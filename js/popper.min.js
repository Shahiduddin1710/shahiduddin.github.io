 ...
 */ (function(
  ...
  function u(e, o) {
    ...
    if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
      ...
      (h.top -= l - u), (h.bottom -= l - u), (h.left -= m - b), (h.right -=
    ...
    if ("viewport" === r) p = b(s);
      ...
      if ("HTML" === a.nodeName && !y(s)) {
        var l = h(),
          m = l.height,
          c = l.width;
        (p.top += f.top - f.marginTop), (p.bottom = m + f.top), (p.left +=
          f.left - f.marginLeft), (p.right = c + f.left);
      } else p = f;
    }
  ...
  function S(e, t, o) {
    ...
    var i = O(e),
      ...
      a = r ? "width" : "height";
    return (n[p] =
      t[p] + t[d] / 2 - i[d] / 2), (n[s] = o === s ? t[s] - i[a] : t[L(s)]), n;
  }
  function T(e, t) {
  ...
  function k() {
    if (!this.state.isDestroyed) {
      ...
      (e.offsets.reference = x(
        ...
        e.offsets.reference,
        e.placement
      )), (e.offsets.popper.position = "absolute"), (e = N(
        this.modifiers,
        e
    ...
    le = (function() {
      function t(o, i) {
        ...
        ne(this, t), (this.scheduleUpdate = function() {
          ...
          isCreated: !1,
          scrollParents: [],
        }), (this.reference = o.jquery ? o[0] : o), (this.popper = i.jquery
          ? i[0]
  ...
  return (le.Utils = ("undefined" == typeof window
    ? global
    : window).PopperUtils), (le.placements = de), (le.Defaults = {
    placement: "bottom",
    eventsEnabled: !0,
    removeOnDestroy: !1,
    onCreate: function() {},
    ...
    modifiers: {
      ...
      offset: {
        ...
        fn: function(e, t) {
          var o,
            ...
            s = r.reference,
            d = n.split("-")[0];
          return (o = R(+i) ? [+i, 0] : G(i, p, s, d)), "left" === d
            ...
            : "right" === d
              ...
              : "top" === d
                ...
                : "bottom" === d &&
                  ((p.left += o[0]), (p.top += o[1])), (e.popper = p), e;
        },
        offset: 0,
      },
      preventOverflow: {
      ...
      arrow: {
        ...
        fn: function(e, t) {
          ...
          var i = e.placement.split("-")[0],
            ...
            l = s ? "bottom" : "right",
            m = O(o)[d];
          p[l] - m < r[a] && (e.offsets.popper[a] -= r[a] - (p[l] - m)), p[a] +
            m >
            r[l] && (e.offsets.popper[a] += p[a] + m - r[l]);
          var h = p[a] + p[d] / 2 - m / 2,
            g = h - c(e.offsets.popper)[a];
          return (g = _(
            z(r[d] - m, g),
            0
          )), (e.arrowElement = o), (e.offsets.arrow = {}), (e.offsets.arrow[
            a
          ] = Math.round(g)), (e.offsets.arrow[f] = ""), e;
        },
        element: "[x-arrow]",
      },
      flip: {
      ...
      inner: {
        ...
        fn: function(e) {
          ...
          return (n[p ? "left" : "top"] =
            r[t] - (s ? n[p ? "width" : "height"] : 0)), (e.placement = L(
            t
      ...
      computeStyle: {
        ...
        fn: function(e, t) {
          ...
          return (e.attributes = se({}, v, e.attributes)), (e.styles = se(
            {},
            m,
            e.styles
          )), e;
      ...
      applyStyle: {
        ...
        enabled: !0,
        fn: function(e) {
          return U(e.instance.popper, e.styles), Y(
            e.instance.popper,
            e.attributes
