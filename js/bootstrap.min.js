...
!(function(t, e) {
  ...
  (g =
    g && g.hasOwnProperty("default")
      ? g.default
      : g), (u = u && u.hasOwnProperty("default") ? u.default : u);
  var e = "transitionend";
  function n(t) {
    var e = this,
      n = !1;
  ...
  ), (g.fn[o] = p._jQueryInterface), (g.fn[o].Constructor = p), (g.fn[
    o
  ].noConflict = function() {
    ...
    P = (function() {
      ...
      return (t.toggle = function() {
        ...
        return this.each(function() {
          var t = g(this).data(y);
          t ||
            ((t = new n(this)), g(this).data(y, t)), "toggle" === e && t[e]();
        });
      }), s(n, null, [
        {
          key: "VERSION",
  ...
  g(document)
    .on(k.CLICK_DATA_API, D, function(t) {
      ...
      var e = t.target;
      g(e).hasClass(b) ||
        (e = g(e).closest(O)), P._jQueryInterface.call(g(e), "toggle");
    })
    .on(k.FOCUS_BLUR_DATA_API, D, function(t) {
      var e = g(t.target).closest(O)[0];
      g(e).toggleClass(I, /^focus(in)?$/.test(t.type));
    }), (g.fn[v] = P._jQueryInterface), (g.fn[v].Constructor = P), (g.fn[
    v
  ].noConflict = function() {
  ...
  var L = "carousel",
    ...
    lt = (function() {
      ...
      return (t.next = function() {
        ...
        g(this._element).off(H), g.removeData(
          this._element,
          j
            ...
            g(s)
              .one(_.TRANSITION_END, function() {
                g(l)
                  ...
                  .addClass(
                    V
                  ), g(s).removeClass(V + " " + i + " " + n), (r._isSliding = !1), setTimeout(function() {
                  return g(r._element).trigger(u);
                }, 0);
              })
              .emulateTransitionEnd(d);
          } else
            g(s).removeClass(V), g(l).addClass(V), (this._isSliding = !1), g(
              this._element
            ).trigger(u);
          h && this.cycle();
        }
  ...
  g(document).on(Q.CLICK_DATA_API, rt, lt._dataApiClickHandler), g(
    window
  ...
  }), (g.fn[L] = lt._jQueryInterface), (g.fn[L].Constructor = lt), (g.fn[
    L
  ].noConflict = function() {
            ...
            g(this._element)
              .one(_.TRANSITION_END, function() {
                g(n._element)
                  ...
                  .addClass(
                    mt
                  ), (n._element.style[o] = ""), n.setTransitioning(!1), g(n._element).trigger(_t.SHOWN);
              })
              .emulateTransitionEnd(s), (this._element.style[o] =
              this._element[r] + "px");
          }
        }
      }), (t.hide = function() {
        ...
        if (!this._isTransitioning && g(this._element).hasClass(mt)) {
          ...
          if ((g(this._element).trigger(e), !e.isDefaultPrevented())) {
            ...
            (this._element.style[n] =
              this._element.getBoundingClientRect()[n] + "px"), _.reflow(
              this._element
  ...
  }), (g.fn[ct] = bt._jQueryInterface), (g.fn[ct].Constructor = bt), (g.fn[
    ct
  ].noConflict = function() {
  ...
  var It = "dropdown",
    ...
    Jt = (function() {
      ...
      return (t.toggle = function() {
            ...
            if ((g(t).trigger(i), !i.isDefaultPrevented())) {
              if (!this._inNavbar) {
                ...
                "parent" === this._config.reference
                  ...
                  g(t).addClass(Ft), (this._popper = new u(
                  o,
                  this._menu,
              ...
              "ontouchstart" in document.documentElement &&
                ...
                "aria-expanded",
                !0
              ), g(this._menu).toggleClass(Lt), g(t)
                .toggleClass(Lt)
        ...
        g.removeData(this._element, Dt), g(this._element).off(
          wt
        ...
        return (t = l(
          ...
          t
        )), _.typeCheckConfig(It, t, this.constructor.DefaultType), t;
        ...
        return t.hasClass(jt)
          ...
          : t.hasClass(Ht)
            ...
            : t.hasClass(Rt)
              ? (e = Xt)
              : g(this._menu).hasClass(xt) && (e = Yt), e;
  ...
  g(document)
    ...
    .on(kt.CLICK_DATA_API, Wt, function(t) {
      t.stopPropagation();
    }), (g.fn[It] = Jt._jQueryInterface), (g.fn[It].Constructor = Jt), (g.fn[
    It
  ].noConflict = function() {
    ...
    ve = (function() {
      ...
      return (t.toggle = function(t) {
        ...
        [window, this._element, this._dialog].forEach(function(t) {
          return g(t).off(ee);
        }), g(document).off(re.FOCUSIN), g.removeData(
          this._element,
          te
        ...
        (this._element.parentNode &&
          ...
          "aria-hidden"
        ), this._element.setAttribute("aria-modal", !0), g(
          this._dialog
        ).hasClass(se)
        ...
        (this._element.style.display = "none"), this._element.setAttribute(
          ...
          g(document.body).removeClass(
            ce
          ), t._resetAdjustments(), t._resetScrollbar(), g(t._element).trigger(re.HIDDEN);
        });
  ...
  }), (g.fn[Zt] = ve._jQueryInterface), (g.fn[Zt].Constructor = ve), (g.fn[
    Zt
  ].noConflict = function() {
  ...
  var be = "tooltip",
    ...
    Be = (function() {
      ...
      return (t.enable = function() {
        ...
        clearTimeout(this._timeout), g.removeData(
          this.element,
          this.constructor.DATA_KEY
        ), g(this.element).off(this.constructor.EVENT_KEY), g(this.element)
          .closest(".modal")
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          o.setAttribute("id", r), this.element.setAttribute(
            "aria-describedby",
            r
          ), this.setContent(), this.config.animation && g(o).addClass(xe);
          var s =
          ...
          g(o).data(this.constructor.DATA_KEY, this), g.contains(
            ...
            this.tip
          ) || g(o).appendTo(l), g(this.element).trigger(
          ...
          var c = function() {
            ...
            var t = e._hoverState;
            (e._hoverState = null), g(e.element).trigger(
        ...
        var e = this,
          ...
          o = function() {
            e._hoverState !== je &&
              ...
              "aria-describedby"
            ), g(e.element).trigger(e.constructor.Event.HIDDEN), null !==
        ...
        this.setElementContent(g(t.querySelectorAll(Ue)), this.getTitle()), g(
          t
        ).removeClass(xe + " " + Fe);
        ...
        (e = e || g(t.currentTarget).data(n)) ||
          ...
          ), t && (e._activeTrigger["focusin" === t.type ? Me : qe] = !0), g(
          e.getTipElement()
        ).hasClass(Fe) || e._hoverState === je
          ? (e._hoverState = je)
          : (
        ...
        return Object.keys(e).forEach(function(t) {
          ...
          typeof t.content &&
          (t.content = t.content.toString()), _.typeCheckConfig(
          be,
          t,
  ...
  (g.fn[be] = Be._jQueryInterface), (g.fn[be].Constructor = Be), (g.fn[
    be
  ].noConflict = function() {
  ...
  (g.fn[Ve] = sn._jQueryInterface), (g.fn[Ve].Constructor = sn), (g.fn[
    Ve
  ].noConflict = function() {
  ...
  var an = "scrollspy",
    ...
    Dn = (function() {
      ...
      return (t.refresh = function() {
        ...
        g.removeData(this._element, ln), g(this._scrollElement).off(
          cn
  ...
  }), (g.fn[an] = Dn._jQueryInterface), (g.fn[an].Constructor = Dn), (g.fn[
    an
  ].noConflict = function() {
    ...
    Kn = (function() {
      ...
      return (t.show = function() {
        ...
        if (e) {
          ...
          i && g(i).removeClass(Pn), "tab" === e.getAttribute("role") &&
  ...
  g(document).on(On.CLICK_DATA_API, Wn, function(t) {
    ...
    Kn._jQueryInterface), (g.fn.tab.Constructor = Kn), (g.fn.tab.noConflict = function() {
  ...
  var Qn = "toast",
    ...
    ni = (function() {
      ...
      return (t.show = function() {
        ...
        var e = function() {
          t._element.classList.remove(Jn), t._element.classList.add(Gn), g(
            t._element
        ...
        clearTimeout(
          this._timeout
        ), (this._timeout = null), this._element.classList.contains(Gn) &&
          this._element.classList.remove(Gn), g(this._element).off(
          zn.CLICK_DISMISS
        ), g.removeData(
          this._element,
          Bn
  ...
  (g.fn[Qn] = ni._jQueryInterface), (g.fn[Qn].Constructor = ni), (g.fn[
    Qn
  ].noConflict = function() {
