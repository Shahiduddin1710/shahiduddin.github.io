...
void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0), (function(e) {
  ...
  (e.fn.init = function(e) {
    ...
    return "string" == typeof e &&
      "#" === e &&
      (r("jQuery( '#' ) is not a valid selector"), (t[0] = [])), i.apply(
      this,
      t
    );
  ...
  (e.fn.size = function() {
    ...
    return n !== a &&
      r("jQuery.isNumeric() should not be called on constructed objects"), a;
  ...
  (e.event.props = []), (e.event.fixHooks = {}), n(e.event.props, "concat", e.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"), (e.event.fix = function(
    ...
    undelegate: function(e, t, n) {
      return r("jQuery.fn.undelegate() is deprecated"), 1 === arguments.length
        ? this.off(e, "**")
        : this.off(t, e || "**", n);
    },
    hover: function(e, t) {
      return r("jQuery.fn.hover() is deprecated"), this.on("mouseenter", e).on(
        "mouseleave",
        t || e
      );
    },
  ...
  return (e.Deferred = function(t) {
    ...
    return (n.pipe = a.pipe = function() {
      var t = arguments;
      return r("deferred.pipe() is deprecated"), e
        .Deferred(function(r) {
